...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SeerNetAudioApIs.DenoiseApi = factory(root.SeerNetAudioApIs.ApiClient, root.SeerNetAudioApIs.AsyncResponse, root.SeerNetAudioApIs.Audio);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.asyncDenoiseAudio = function(body, callback) {
      var postBody = body;
      ...
      return this.apiClient.callApi(
        '/api/v1/audio/async/denoise', 'POST',
    ...
    this.syncDenoiseAudio = function(body, callback) {
      ...
      return this.apiClient.callApi(
        '/api/v1/audio/sync/denoise', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
