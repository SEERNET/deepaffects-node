...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DeepAffects.DiarizeApi = factory(root.DeepAffects.ApiClient, root.DeepAffects.AsyncResponse, root.DeepAffects.Audio, root.DeepAffects.DiarizeAudio);
  }
  ...
  var exports = function(apiClient) {
    ...
    this.asyncDiarizeAudio = function(body, webhook, callback, request_id) {
      ...
      return this.apiClient.callApi(
        '/audio/generic/api/v1/async/diarize', 'POST',
    ...
    this.syncDiarizeAudio = function(body, callback) {
      ...
      return this.apiClient.callApi(
        '/audio/generic/api/v1/sync/diarize', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
